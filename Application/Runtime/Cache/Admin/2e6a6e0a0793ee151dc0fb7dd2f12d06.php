...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- END PAGE HEADER-->
             <a href="<?php echo U('article_add');?>" class="btn btn-primary">
            添加文章</a><br><br>
            <form action="<?php echo U('article');?>"> <input type="text"  placeholder="标题" name="name" value="<?php echo I('name');?>">   <button type="submit" class="btn green  btn-sm">   搜索   </button></form><br> 
            <!-- BEGIN PAGE CONTENT-->
            <div class="row">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="tools">
                          ...
                          <button id="delete" class="btn btn-sm btn-success  filter-submit margin-bottom">删除</button>
                            ...
                            <thead >
                             <tr ><th style="width:5%">选择</th><!-- <th style="width:5%">ID</th> --><th style="width:25%">名称</th><th>类别</th><th>来源</th><th>时间</th><th>操作</th></tr>
                            </thead>
                            <tbody>
                            <?php if(is_array($com)): foreach($com as $key=>$v): ?><tr >
                             <td style="vertical-align:middle;"><input type="checkbox" class="selectid" id="id<?php echo ($v["id"]); ?>" name="id" value="<?php echo ($v["id"]); ?>"></td>
                               <!-- <td style="vertical-align:middle;" ><?php echo ($v["id"]); ?></td> --> <td style="vertical-align:middle;" ><?php echo ($v["title"]); ?></td>
                                 <td style="vertical-align:middle;" ><?php echo M('weixin_catch_news_column')->where(array('id'=>$v['pid']))->getField('title') ?></td>
                                 <td style="vertical-align:middle;" ><?php echo ($v["source"]); ?></td>
                                <td style="vertical-align:middle;" ><?php echo (date('Y-m-d H:i:s',$v["addtime"])); ?></td>
                            <td style="vertical-align:middle;"> 
                                 <a href="<?php echo U('article_add',array('id' =>$v['id'],'p'=>$_GET['p']));?>" class="btn btn-warning  btn-sm"><i class="fa fa-pencil"></i> 修改</a>
...
<!-- END JAVASCRIPTS -->
  ...
  $(function () {
    var deleteselect="<?php echo U('articledeleteajax');?>";
