                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            <form role="form" action="<?php echo U('index_save');?>" name="adminadd"  method="post">
                                <div class="form-body">
                                <input type="hidden" name="id" value="<?php echo ($store["_id"]); ?>">
                                <table class="table table-bordered table-hover">

                            <tbody>
                            <tr><td colspan="2">区域代理提成比例:</td><td colspan="2"><?php echo ($store["yiji"]); ?></td></tr>

                            

                 
                             <tr>
                             <td>普通会员提二级比例:</td><td><?php echo ($store["level1"]["0"]); ?></td>
                             <td>普通会员提三级比例:</td><td><?php echo ($store["level2"]["0"]); ?></td>

                             </tr>

                              <tr>
                              <td>黄金会员提二级比例:</td><td><?php echo ($store["level1"]["1"]); ?></td>
                               <td>黄金会员提三级比例:</td><td><?php echo ($store["level2"]["1"]); ?></td>

                              </tr>

                               <tr>
                               <td>铂金会员提二级比例:</td><td><?php echo ($store["level1"]["2"]); ?></td>
                               <td>铂金会员提三级比例:</td><td><?php echo ($store["level2"]["2"]); ?></td>
                               </tr>

                            <tr><td>钻石会员提二级比例:</td><td><?php echo ($store["level1"]["3"]); ?></td>
                            <td>钻石会员提三级比例:</td><td><?php echo ($store["level2"]["3"]); ?></td>
                                   ...
                                   <div class="form-group">
                                        <label>区域代理提成比例</label>
                                        <div class="input-group">
                                         <input type="text" id="yiji" class="form-control" placeholder="0.1-0.9" name="yiji"  value="<?php echo ($store["yiji"]); ?>">

                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label>普通会员提二级比例</label>  
                                        <div class="input-group">
                                         <input type="text"  class="form-control" placeholder="0.1-0.9" name="level1[]"  value="<?php echo ($store["level1"]["0"]); ?>">

                                        </div>

                                        <label style="">普通会员提三级比例</label>
                                        <div class="input-group">
                                         <input type="text"  class="form-control" placeholder="0.1-0.9" name="level2[]"  value="<?php echo ($store["level2"]["0"]); ?>">
                                    ...
                                    <div class="form-group">
                                        <label>黄金会员提二级比例</label>
                                        <div class="input-group">
                                         <input type="text"  class="form-control" placeholder="0.1-0.9" name="level1[]"  value="<?php echo ($store["level1"]["1"]); ?>">

                                        </div>
                                         <label>黄金会员提三级比例</label>
                                        <div class="input-group">
                                         <input type="text"  class="form-control" placeholder="0.1-0.9" name="level2[]"  value="<?php echo ($store["level2"]["1"]); ?>">

                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label>铂金会员提二级比例</label>
                                        <div class="input-group">
                                         <input type="text"  class="form-control" placeholder="0.1-0.9" name="level1[]"  value="<?php echo ($store["level1"]["2"]); ?>">

                                        </div>
                                         <label>铂金会员提三级比例</label>
                                        <div class="input-group">
                                         <input type="text"  class="form-control" placeholder="0.1-0.9" name="level2[]"  value="<?php echo ($store["level2"]["2"]); ?>">

                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label>钻石会员提二级比例</label>
                                        <div class="input-group">
                                         <input type="text"  class="form-control" placeholder="0.1-0.9" name="level1[]"  value="<?php echo ($store["level1"]["3"]); ?>">

                                        </div>
                                         <label>钻石会员提三级比例</label>
                                        <div class="input-group">
                                         <input type="text"  class="form-control" placeholder="0.1-0.9" name="level2[]"  value="<?php echo ($store["level2"]["3"]); ?>">
