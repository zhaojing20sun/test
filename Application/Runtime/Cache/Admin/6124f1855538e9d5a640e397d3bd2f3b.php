        ...
        <div class="page-content">
            ...
            <!-- END PAGE HEADER-->
               <!--  <a href="<?php echo U('set_guanjian_add');?>" class="btn btn-primary">
                           添加关键词</a><br><br> -->
           <!--   <form action="<?php echo U('project_complainlist');?>"> <input type="text"  placeholder="标题" name="name" value="<?php echo I('name');?>">   <button type="submit" class="btn green  btn-sm">   搜索   </button></form> -->
            <!-- BEGIN PAGE CONTENT-->
            <div class="row">
                    ...
                    <div class="portlet box blue">
                        ...
                        <!-- <div class="tools">
                          ...
                          <button id="delete" class="btn btn-sm btn-success  filter-submit margin-bottom">删除</button>
                            ...
                            <thead >
                             <tr ><th>ID</th><th>昵称</th><th>openid</th><th>性别</th><th>地点</th><th>关注时间</th><th>活跃时间</th><th>操作</th></tr>
                            </thead>
                            <tbody>
                            <?php if(is_array($project)): foreach($project as $key=>$v): ?><tr >
                             <td style="vertical-align:middle;" ><?php echo ($v["tel"]); ?></td>
                              <td style="vertical-align:middle;" ><?php echo ($v["tel"]); ?></td>
                               <td style="vertical-align:middle;" ><?php echo ($v["tel"]); ?></td>
                               <td style="vertical-align:middle;" ><?php echo ($v["tel"]); ?></td>
                               <td style="vertical-align:middle;" ><?php echo ($v["email"]); ?></td>
                                 <td style="vertical-align:middle;width:300px;"><?php echo (mb_substr(strip_tags(htmlspecialchars_decode($v["content"])),0,100,utf8)); ?>...</td>
                                 
                                 <td  style="vertical-align:middle;"><?php echo (date("Y-m-d H:i:s",$v["jointime"])); ?></td>
                                <td style="vertical-align:middle;"> 
                               
                                  <a href="<?php echo U('project_messagedelete',array('id' =>$v['id']));?>" class="btn btn-danger  btn-sm" onclick="return confirm('您确定要删除该项吗，如不确定请点取消')"><i class="glyphicon glyphicon-remove"></i> 删除</a>
