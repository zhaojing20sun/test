                ...
                <div class="col-md-12 ">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            <form role="form" action="<?php echo U('wx_bangding_save');?>" name="adminadd"  method="post" enctype="multipart/form-data">
                                <div class="form-body">
                                ...
                                <input type="hidden" name="userid" value="<?php echo ($weixin["userid"]); ?>"/>
                                    <div class="form-group">
                                        <label><i style="color:red;"></i> 微信原始ID：</label>
                                        <div class="input-group">
                                         <input name="wxid" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('微信原始ID不能为空')" oninput="setCustomValidity('')"  value="<?php echo ($weixin["wxid"]); ?>"/>
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label><i style="color:red;"></i> 微信名称：</label>
                                        <div class="input-group">
                                         <input name="wxname" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('微信原始ID不能为空')" oninput="setCustomValidity('')"  value="<?php echo ($weixin["wxname"]); ?>"/>
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label><i style="color:red;"></i> 接口URL：</label>
                                        <div class="input-group">
                                         <input name="url" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('微信原始ID不能为空')" oninput="setCustomValidity('')"  value="<?php echo ($weixin["url"]); ?>"/>
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label><i style="color:red;"></i> 指纹(Token)：</label>
                                        <div class="input-group">
                                         <input name="token" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('微信原始ID不能为空')" oninput="setCustomValidity('')"  value="<?php echo ($weixin["token"]); ?>"/>
                                        </div>
                                    </div>
                                     <div class="zc01 red" style="color:red; top:35px;">*注意：以下为 "开发者凭据"，请保持与微信公众后台一致！</div>
                                   <div class="form-group">
                                        <label><i style="color:red;"></i>AppId：</label>
                                        <div class="input-group">
                                         <input name="appid" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('微信原始ID不能为空')" oninput="setCustomValidity('')"  value="<?php echo ($weixin["appid"]); ?>"/>
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label><i style="color:red;"></i> AppSecret：</label>
                                        <div class="input-group">
                                         <input name="appsecret" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('微信原始ID不能为空')" oninput="setCustomValidity('')"  value="<?php echo ($weixin["appsecret"]); ?>"/>
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label><i style="color:red;"></i> EncodingAESKey:</label>
                                        <div class="input-group">
                                         <input name="key" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('微信原始ID不能为空')" oninput="setCustomValidity('')"  value="<?php echo ($weixin["key"]); ?>"/>
                                        </div>
                                    </div>
                                </div>
