                               ...
                               <!--  <div class="zc01 red" style="color:red; top:35px;">*注意：此指纹(Token) / AppId / AppSecret 必须与微信公众号后台一致,否则无法通信!</div> -->
                                <input type="hidden" name="id" value="<?php echo ($weixin["id"]); ?>"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if(is_array($filed)): foreach($filed as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($weixin['pid']==$v['id']) echo 'selected'?>><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                        </div>
                                    </div>
                                      <div class="form-group">
