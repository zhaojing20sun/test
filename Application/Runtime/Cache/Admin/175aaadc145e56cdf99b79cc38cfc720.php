                        ...
                        <!--  <div class="tools">
                         ...
                         <button id="delete" class="btn btn-sm btn-success  filter-submit margin-bottom">删除</button>
                           ...
                           <?php if($v['_id']!=$admin10['_id']){ ?>
                                ...
                                <td>
                                 <?php  if($v['permission']){ switch ($v['level']) { case '1': echo '<span style="color:#87CEEB">个人代理</span>-<span style="color:#5CACEE">[普通会员]</span>'; break; case '2': echo '<span style="color:#87CEEB">个人代理</span>-<span style="color:#EEC900">[黄金会员]</span>'; break; case '3': echo '<span style="color:#87CEEB">个人代理</span>-<span style="color:#FCFCFC">[铂金会员]</span>'; break; case '4': echo '<span style="color:#87CEEB">个人代理</span>-<span style="color:#EE0000">[钻石会员]</span>'; break; } }else{ switch ($v['level']) { case '1': echo '<span style="color:#5CACEE">[普通会员]</span>'; break; case '2': echo '<span style="color:#EEC900">[黄金会员]</span>'; break; case '3': echo '<span style="color:#FCFCFC">[铂金会员]</span>'; break; case '4': echo '<span style="color:#EE0000">[钻石会员]</span>'; break; } } ?>

                                </td> 
                                <td>
                                <?php  $admin=new \Think\Model\MongoModel('admin'); echo $admin->where(array('_id'=>$v['pid']))->getfield('address'); ?>
                                </td>
                                <td></td>
                              
                                <td><?php echo (date('Y-m-d H:i:s',$v["addtime"])); ?></td>
                           <td><a href="" style="color:blue">成为代理</a></td>
                            </tr>
