                        ...
                        <!--  <div class="tools">
                         ...
                         <button id="delete" class="btn btn-sm btn-success  filter-submit margin-bottom">删除</button>
                           ...
                           <!--  <th>等级</th> -->
                            ...
                            <tbody>
                            <?php if(is_array($log)): foreach($log as $key=>$v): ?><tr>
                           
                              
                                <td>
                            <?php  $admin=new \Think\Model\MongoModel('admin'); $re=$admin->where(array('_id'=>$v['aid']))->find(); echo $re['nickname']; ?>
                               </td>
                              ...
                              <?php echo (date('Y-m-d H:i:s',$v["addtime"])); ?>
                                 ...
                                 <td>
                             <?php  $admin=new \Think\Model\MongoModel('admin'); $re=$admin->where(array('_id'=>$v['baid']))->find(); echo $re['nickname']; ?>
                                </td>
