...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- END PAGE HEADER-->
             <a href="<?php echo U('company_filed_add');?>" class="btn btn-primary">
            添加类别</a><br><br>
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="tools">
                          ...
                          <button id="delete" class="btn btn-sm btn-success  filter-submit margin-bottom">删除</button>
                            ...
                            <thead >
                             <tr ><th>选择</th><th>标题</th><th>操作</th></tr>
                            </thead>
                            <tbody>
                            ...
                            <td style="vertical-align:middle;"> 
                                 <a href="<?php echo U('company_filed_add',array('id' =>$v['id'],'p'=>$_GET['p']));?>" class="btn btn-warning  btn-sm"><i class="fa fa-pencil"></i> 修改</a>
                                  <a href="<?php echo U('company_filed_delete',array('id' =>$v['id']));?>" class="btn btn-danger  btn-sm" onclick="return confirm('您确定要删除该项吗，如不确定请点取消')"><i class="glyphicon glyphicon-remove"></i> 删除</a>
...
<!-- END JAVASCRIPTS -->
  ...
  $(function () {
    var deleteselect="<?php echo U('company_fileddeleteajax');?>";
