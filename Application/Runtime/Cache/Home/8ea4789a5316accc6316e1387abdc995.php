...
<a href="<?php echo U('product_pic_add');?>" class="btn btn-primary" style="   margin-top: 10px;">
            添加图片  </a>
            </div>
<table class="table table-bordered table-hover" style="text-align:center;    margin-top: 10px;">
                           ...
                           <td style="vertical-align:middle;"><img src="/new_lgx/<?php echo ($v["logo"]); ?>" width="100"></td>
                            <td style="vertical-align:middle;"> 
                                 <a href="<?php echo U('product_pic_change',array('id'=>$v['id']));?>" class="btn btn-warning  btn-sm"><i class="fa fa-pencil"></i> 修改</a>
