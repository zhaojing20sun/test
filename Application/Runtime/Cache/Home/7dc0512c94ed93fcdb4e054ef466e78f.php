...
<div id="right">
   <form role="form" action="<?php echo U('broadcast_column_add_save');?>" name="adminadd"  method="post" enctype="multipart/form-data">
                               ...
                               <!--  <div class="zc01 red" style="color:red; top:35px;">*注意：此指纹(Token) / AppId / AppSecret 必须与微信公众号后台一致,否则无法通信!</div> -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                         <input name="title" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('分类标题不能为空')" oninput="setCustomValidity('')"  value="<?php echo ($weixin["title"]); ?>"/>
                                        </div>
                                    </div>
