...
<a href="<?php echo U('easy_column_add');?>" class="btn btn-primary" style="   margin-top: 10px;">
            添加分类</a>
            </div>
<table class="table table-bordered table-hover" style="text-align:center;    margin-top: 10px;">
                            ...
                            <td style="vertical-align:middle;"> 
                                 <a href="<?php echo U('easy_column_change',array('id'=>$v['id']));?>" class="btn btn-warning  btn-sm"><i class="fa fa-pencil"></i> 修改</a>
                                  <a href="<?php echo U('easy_column_delete',array('id'=>$v['id']));?>" class="btn btn-danger  btn-sm" onclick="return confirm('您确定要删除该项吗，如不确定请点取消')"><i class="glyphicon glyphicon-remove"></i> 删除</a>
