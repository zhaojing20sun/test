...
<a href="<?php echo U('nav_add');?>" class="btn btn-primary" style="   margin-top: 10px;">
            添加导航  </a>
            </div>
<table class="table table-bordered table-hover" style="text-align:center;    margin-top: 10px;">
                            <thead>
                             <tr><th>标题</th><th>地址</th><th>图片</th><th>操作</th></tr>
                            </thead>
                            <tbody>
                           ...
                           <td style="vertical-align:middle;"><img src="/new_lgx/<?php echo ($v["logo"]); ?>" width="100"></td>
                            <td style="vertical-align:middle;"> 
                                 <a href="<?php echo U('nav_change',array('id'=>$v['id']));?>" class="btn btn-warning  btn-sm"><i class="fa fa-pencil"></i> 修改</a>
                                  <a href="<?php echo U('nav_delete',array('id'=>$v['id']));?>" class="btn btn-danger  btn-sm" onclick="return confirm('您确定要删除该项吗，如不确定请点取消')"><i class="glyphicon glyphicon-remove"></i> 删除</a>
