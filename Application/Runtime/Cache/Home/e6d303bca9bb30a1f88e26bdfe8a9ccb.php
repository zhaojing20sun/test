...
<div id="right">
   <form role="form" action="<?php echo U('show_change_save');?>" name="adminadd"  method="post" enctype="multipart/form-data">
                               ...
                               <input type="hidden" name="id" value="<?php echo ($show["id"]); ?>">
                                    ...
                                    <div class="form-group" style="margin-top:10px;">
                                        ...
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                         <input name="url" id="realname" type="text" class="form-control input-xlarge"  oninvalid="setCustomValidity('直播地址不能为空')" oninput="setCustomValidity('')" value="<?php echo ($show["url"]); ?>" />
                                        </div>
                                    </div>
                                       <script type="text/javascript">
                                 $(function(){
