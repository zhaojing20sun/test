...
<div id="right">
   <form role="form" action="<?php echo U('activity_add_save');?>" name="adminadd"  method="post" enctype="multipart/form-data">
                               ...
                               <!--  <div class="zc01 red" style="color:red; top:35px;">*注意：此指纹(Token) / AppId / AppSecret 必须与微信公众号后台一致,否则无法通信!</div> -->
                                    ...
                                    <div class="form-group" style="margin-top:10px;">
                                       ...
                                       <div class="form-group moban1" style="margin-top:10px;display:none">
                                        <label><i style="color:red;"></i> 选择模板：</label>
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                        <select name="moban" style="width:100px;">
                                     ...
                                     <div class="form-group img2 img" style="margin-top:10px;display:none">
                                        ...
                                        <div class="input-group" style="border:1px solid red;margin-top:10px;margin-left:15px;width:310px;height:300px;overflow:hidden">
                                     ...
                                     <div class="form-group img3 img" style="margin-top:10px;display:none">
                                      ...
                                      <div class="form-group" style="margin-top:10px;">
                                        ...
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                        <input name="start_time" id="start_time" type="text" class="form-control input-xlarge" required onfocus="SelectDate(this,'yyyy-MM-dd hh:mm:ss')" >
                                        </div>
                                    </div>
                                     <div class="form-group" style="margin-top:10px;">
                                        <label><i style="color:red;"></i> 结束时间：</label>
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                        <input name="end_time" id="end_time" type="text" class="form-control input-xlarge" required onfocus="SelectDate(this,'yyyy-MM-dd hh:mm:ss')" >
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group" style="margin-top:10px;">
                                        ...
                                        <div class="input-group" style="margin-top:10px;">
                                              ...
                                              <textarea rows="30" cols="80" placeholder="" name="content" id="content"></textarea>
                                              </div>
                                              </div>
                                        </div>
                                </div>
 ...
 <script type="text/javascript">
   ...
   $("form").submit(function(){
      if($("select[name='type']").val()!=0 && $("select[name='moban']").val()==''){
        alert('未选择模板')
        return false
      }
   })
