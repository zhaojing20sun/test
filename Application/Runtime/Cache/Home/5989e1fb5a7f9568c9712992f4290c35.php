...
<a href="<?php echo U('broadcast_column_add');?>" class="btn btn-primary" style="   margin-top: 10px;">
            添加分类</a>
            <span style="color:red">标题请控制在5个字以内</span>
            </div>
<table class="table table-bordered table-hover" style="text-align:center;    margin-top: 10px;">
                            <thead>
                             <tr><th>标题</th><th style="width:5%">排序</th><th>操作</th></tr>
                            </thead>
                            <tbody>
                            ...
                            <td style="vertical-align:middle;"> 
                                 <a href="<?php echo U('broadcast_column_change',array('id'=>$v['id']));?>" class="btn btn-warning  btn-sm"><i class="fa fa-pencil"></i> 修改</a>
                                  <a href="<?php echo U('broadcast_column_delete',array('id'=>$v['id']));?>" class="btn btn-danger  btn-sm" onclick="return confirm('您确定要删除该项吗，如不确定请点取消')"><i class="glyphicon glyphicon-remove"></i> 删除</a>
...
$(function(){
  $(".order").change(function(){
       ...
       $.ajax({
          url:"<?php echo U('broadcast_order_change');?>",
          type:'post',
