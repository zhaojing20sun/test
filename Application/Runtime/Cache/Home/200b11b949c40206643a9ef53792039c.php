...
<a href="<?php echo U('lanmu_add');?>" class="btn btn-primary" style="   margin-top: 10px;">
            添加分类</a>
...
<table class="table table-bordered table-hover" style="text-align:center;    margin-top: 10px;">
                            ...
                            <?php if($v['title']!='热点'){ ?>
                                 <a href="<?php echo U('lanmu_change',array('id'=>$v['id']));?>" class="btn btn-warning  btn-sm"><i class="fa fa-pencil"></i> 修改</a>
                                 <?php }?>
