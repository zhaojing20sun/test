...
<div id="right">
   <form role="form" action="<?php echo U('nav_change_save');?>" name="adminadd"  method="post" enctype="multipart/form-data">
                               ...
                               <input type="hidden" name="id" value="<?php echo ($pic["id"]); ?>"/>
                                <div class="form-group" style="margin-top:0px;">
                                        ...
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                         <input name="title" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('标题不能为空')" oninput="setCustomValidity('')"  value="<?php echo ($pic["title"]); ?>" />
                                        </div>
                                    </div>
                                      <div class="form-group" style="margin-top:10px;">
                                        <label><i style="color:red;"></i> url地址：</label>
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                         <input name="url" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('url地址不能为空')" oninput="setCustomValidity('')"  value="<?php echo ($pic["url"]); ?>"/>
                                        </div>
                                    </div>
                                   <div class="form-group" style="margin-top:10px;">
