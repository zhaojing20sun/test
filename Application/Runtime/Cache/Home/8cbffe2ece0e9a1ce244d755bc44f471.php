...
<a href="<?php echo U('broadcast_column');?>" class="btn btn-primary" style="   margin-top: 10px;">
            分类管理</a>
<a href="<?php echo U('broadcast_add');?>" class="btn btn-primary" style="   margin-top: 10px;">
            添加广播信息  </a>&nbsp;
...
<table class="table table-bordered table-hover" style="text-align:center;    margin-top: 10px;">
                           ...
                           <td style="vertical-align:middle;"><input type="text" class="order" value="<?php echo ($v["ordera"]); ?>" style="text-align:center;border:none;width:60px;"><input type="hidden" value="<?php echo ($v["id"]); ?>"></td>
                            <td style="vertical-align:middle;width:160px;"> 
                                 <a href="<?php echo U('broadcast_change',array('id'=>$v['id']));?>" class="btn btn-warning  btn-sm"><i class="fa fa-pencil"></i> 修改</a>
                                  <a href="<?php echo U('broadcast_delete',array('id'=>$v['id']));?>" class="btn btn-danger  btn-sm" onclick="return confirm('您确定要删除该项吗，如不确定请点取消')"><i class="glyphicon glyphicon-remove"></i> 删除</a>
...
$(function(){
  $(".order").change(function(){
       ...
       $.ajax({
          url:"<?php echo U('broadcast_ordera_change');?>",
          type:'post',
