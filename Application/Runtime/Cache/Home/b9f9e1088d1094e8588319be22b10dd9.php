                ...
                <dl>
                  ...
                  <dt class="menu">信息管理</dt>
                    ...
                    <dd>
                         ...
                         <dd>
                            <a href="<?php echo U('show');?>" <?php if($active == 'show'): ?>class="active"<?php else: ?> class="normal"<?php endif; ?>><span class="ico101">直播管理</span></a>
                        </dd>
                         <dd>
...
<div id="right">
   <form role="form" action="<?php echo U('product_column_change_save');?>" name="adminadd"  method="post" enctype="multipart/form-data">
                               ...
                               <input type="hidden" name="id" value="<?php echo ($show["id"]); ?>">
                                    <div class="form-group">
                                        <label><i style="color:red;"></i> 分类标题：</label>
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                         <input name="title" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('分类标题不能为空')" oninput="setCustomValidity('')"  value="<?php echo ($show["title"]); ?>"/>
                                        </div>
                                    </div>
                                      <div class="form-group logo" >
                                        <label><i style="color:red;"></i> 当前图标</label>
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                         <img src="/new_lgx/<?php echo ($show["logo"]); ?>" width="100">
                                        </div>
                                    </div>
                                      <div class="form-group logo"  >
                                        <label><i style="color:red;" ></i> 修改图标：</label>
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                         <input name="logo" id="realname" type="file" class="form-control input-xlarge"  oninvalid="setCustomValidity('分类标题不能为空')" oninput="setCustomValidity('')"  value="<?php echo ($weixin["title"]); ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group" style="margin-top:10px;">
                                        ...
                                        <select name="pid">
                                          ...
                                          <?php if(is_array($column)): foreach($column as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($show['pid']==$v['id']) echo 'selected'?>><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                        </div>
                                    </div>
                                  <script type="text/javascript">
                             $(function(){
                                ...
                                <div class="form-actions" style="padding-left:5%;margin-top:10px;">
                                  <input type="submit" class="btn" value="保  存" style="width:60px">    
