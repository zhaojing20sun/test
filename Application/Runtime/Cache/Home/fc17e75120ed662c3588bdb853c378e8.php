...
<div id="right">
   <form role="form" action="<?php echo U('article_change_save');?>" name="adminadd"  method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group" style="margin-top:10px;">
                                        ...
                                        <select name="column">
                                          ...
                                          <?php if(is_array($column)): foreach($column as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($lanmu['column']==$v['id']) echo 'selected'?>><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                        </div>
                                    </div>
                                    <?php if($lanmu['wid']=='' || $lanmu['wid']=='0'){ ?>
                                     <div class="form-group" style="margin-top:10px;">
                                        <label><i style="color:red;"></i> 来源：</label>
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">

                                         <input name="source" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('来源不能为空')" oninput="setCustomValidity('')"  value="<?php echo ($lanmu["source"]); ?>"/>
                                        </div>
                                    </div>
                                    <?php } ?>
                                     <div class="form-group" style="margin-top:10px;">
