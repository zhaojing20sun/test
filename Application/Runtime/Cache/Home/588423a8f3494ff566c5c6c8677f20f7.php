...
<div id="right">
   <form role="form" action="<?php echo U('easy_change_save');?>" name="adminadd"  method="post" enctype="multipart/form-data">
                               ...
                               <input type="hidden" name="id" value="<?php echo ($show["id"]); ?>">
                                    ...
                                    <div class="form-group" style="margin-top:10px;">
                                        ...
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                         <input name="url" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('链接地址不能为空')" oninput="setCustomValidity('')" value="<?php echo ($show["url"]); ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group" style="margin-top:10px;">
                                        <label><i style="color:red;"></i> 当前图片：</label>
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                         <img src="/new_lgx/<?php echo ($show["logo"]); ?>" width="150">
                                        </div>
                                    </div>
                                     <div class="form-group" style="margin-top:10px;">
