...
<a href="<?php echo U('affiche_add');?>" class="btn btn-primary" style="   margin-top: 10px;">
            添加公告</a>
...
<table class="table table-bordered table-hover" style="text-align:center;    margin-top: 10px;">
                            ...
                            <tbody>
                            <?php if(is_array($affiche)): foreach($affiche as $key=>$v): ?><tr>
                         
                                <td style="vertical-align:middle;"><?php echo ($v["title"]); ?></td>
                           <td style="vertical-align:middle;width:60%" title="<?php echo (strip_tags($v["content"])); ?>"><?php echo (mb_substr(strip_tags($v["content"]),0,90)); ?></td>
                            <td style="vertical-align:middle;"><?php echo (date('Y-m-d H:i:s',$v["addtime"])); ?></td>
                            <td style="vertical-align:middle;"> 
                                <!--  <a href="<?php echo U('affiche_add',array('id'=>$v['id']));?>" class="btn btn-warning  btn-sm"><i class="fa fa-pencil"></i> 修改</a> -->
                                  <a href="<?php echo U('affiche_delete',array('id'=>$v['id']));?>" class="btn btn-danger  btn-sm" onclick="return confirm('您确定要删除该项吗，如不确定请点取消')"><i class="glyphicon glyphicon-remove"></i> 删除</a>
