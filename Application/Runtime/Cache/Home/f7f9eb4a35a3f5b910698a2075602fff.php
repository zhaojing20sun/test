...
<table class="table table-bordered table-hover" style="text-align:center;    margin-top: 10px;">
                            <thead>
                             <tr><th>姓名</th><th>电话</th><th>报名时间</th> <?php if($_GET['type']==2){ ?><th>留言</th>
                          ...
                          <th>投票数</th>
                            ...
                            <?php if(is_array($com)): foreach($com as $key=>$v): ?><tr>
                                ...
                                <td style="vertical-align:middle;"><?php echo ($v["tel"]); ?></td>
                               <td style="vertical-align:middle;"><?php echo (date('Y-m-d H:i:s',$v["addtime"])); ?></td>
                                 <?php if($_GET['type']==2){ ?>
                                  <td style="vertical-align:middle;max-width:100px;"><span title="<?php echo ($v["content"]); ?>"><?php echo ($v["content"]); ?></span></td>
                           
                           
                           
                              <td style="vertical-align:middle;" class="<?php echo ($v["id"]); ?>">
                              <?php switch ($v['status']) { case '0': echo "<span class='yes button'>通过</span> | <span class='no button'>不通过</span>"; break; case '1': echo "<span style='color:green'>通过</span>"; break; case '2': echo "<span style='color:red'>不通过</span>"; break; } ?>
                              </td>
                               <td style="vertical-align:middle;"><?php echo ($v["piao"]); ?></td>
              ...
              <td >
                              <?php } ?>
                                  <a href="<?php echo U('activity_baoming_delete',array('id'=>$v['id']));?>" class="btn btn-danger  btn-sm" onclick="return confirm('您确定要删除该项吗，如不确定请点取消')"><i class="glyphicon glyphicon-remove"></i> 删除</a>
              ...
              <td colspan="4" style="text-align:left">
                              <?php } ?>
                                <?php if(is_array($pic)): foreach($pic as $key=>$v1): ?><a href="/new_lgx<?php echo ($v1["pic"]); ?>" target="__blank">
           <img src="/new_lgx<?php echo ($v1["showpic"]); ?>" style="width:150px;max-height:200px;margin-left:7%;">
