...
<a href="<?php echo U('dynamic_add');?>" class="btn btn-primary" style="   margin-top: 10px;">
            添加分类</a>
            <span style="color:red">分类字数尽量在2-3个字之间，系统默认导航：热门、微聊、关注。</span>
            </div>
<table class="table table-bordered table-hover" style="text-align:center;    margin-top: 10px;">
                            ...
                            <td style="vertical-align:middle;"> 
                                 <a href="<?php echo U('dynamic_add',array('id'=>$v['id']));?>" class="btn btn-warning  btn-sm"><i class="fa fa-pencil"></i> 修改</a>
                                  <a href="<?php echo U('dynamic_delete',array('id'=>$v['id']));?>" class="btn btn-danger  btn-sm" onclick="return confirm('您确定要删除该项吗，如不确定请点取消')"><i class="glyphicon glyphicon-remove"></i> 删除</a>
