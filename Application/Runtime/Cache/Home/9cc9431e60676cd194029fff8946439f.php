...
<a href="<?php echo U('set_man_add');?>" class="btn btn-primary" style="   margin-top: 10px;">
            刷新列表  </a>
            </div>
<table class="table table-bordered table-hover" style="text-align:center;    margin-top: 10px;">
                            <thead>
                             <tr><th>昵称</th><th>openid</th><th>头像</th><th>性别</th><th>所在地区</th><th>关注时间</th></tr>
                            </thead>
                            <tbody>
                            <?php if(is_array($man)): foreach($man as $key=>$v): ?><tr>
                         
                             
                                <td style="vertical-align:middle;"><?php echo ($v["nickname"]); ?></td>
                                <td style="vertical-align:middle;"><?php echo ($v["openid"]); ?></td>
                                <td style="vertical-align:middle;"><img src="<?php echo ($v["headimgurl"]); ?>" width="100" /></td>
                           <td style="vertical-align:middle;"><?php switch ($v['sex']) { case '0': echo '未知'; break; case '1': echo '男'; break; case '2': echo '女'; break; }?></td>
                           <td style="vertical-align:middle;"><?php echo ($v["country"]); echo ($v["province"]); echo ($v["city"]); ?></td>
                           <td style="vertical-align:middle;"><?php echo (date("Y-m-d,H:i:s",$v["subscribe_time"])); ?></td>
