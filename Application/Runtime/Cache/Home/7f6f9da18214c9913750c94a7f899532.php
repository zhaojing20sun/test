...
<div id="right">
   <form role="form" action="<?php echo U('us_save');?>" name="adminadd"  method="post" enctype="multipart/form-data">
                               ...
                               <input type="hidden" name="id" value="<?php echo ($us["id"]); ?>"/>
                                    <div class="form-group">
                                        <label><i style="color:red;"></i> 邮箱：</label>
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                         <input name="email" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('邮箱不能为空')" oninput="setCustomValidity('')" value="<?php echo ($us["email"]); ?>"  />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-top:10px;">
                                        ...
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                         <input name="tel" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('电话不能为空')" oninput="setCustomValidity('')" value="<?php echo ($us["tel"]); ?>"  />
                                        </div>
                                    </div>
                                     
                                          <div class="form-group" style="margin-top:10px;">
                                        <label><i style="color:red;"></i> 服务条款：</label>
                                        <div class="input-group" style="margin-top:10px;">
                                        <textarea name="service" cols="50" rows="8"><?php echo ($us["service"]); ?></textarea>
                                               <!--  <script charset="utf-8" src="/new_lgx/Public/assets/editor/kindeditor.js"></script>
                                                ...
                                                window.editor = K.create('#content',{width:"90%",height:"400px"});
                                                                                             ...
                                                                                             <textarea rows="30" cols="80" placeholder="" name="content" id="content"><?php echo ($us["content"]); ?></textarea>
                                                                                             </div>
                                                                                             </div> -->
                                        </div>
                                </div>
                                <div class="form-group" style="margin-top:10px;">
                                        <label><i style="color:red;"></i> 隐私条款：</label>
                                        <div class="input-group" style="margin-top:10px;">
                                        <textarea name="privacy" cols="50" rows="8"><?php echo ($us["privacy"]); ?></textarea>
