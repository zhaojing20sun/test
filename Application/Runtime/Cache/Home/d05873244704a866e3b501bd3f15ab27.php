                ...
                <dl>
                 ...
                 <dl>
                  <dt class="menu">权限管理</dt>
                   <div style="display:none;">
                       <dd>
                            <a href="<?php echo U('binding_weixin');?>" <?php if($active == 'binding_weixin'): ?>class="active"<?php else: ?> class="normal"<?php endif; ?>><span class="ico100">用户管理</span></a>
                        </dd>
                    <dd>
                            <a href="<?php echo U('follow_reply');?>" <?php if($active == 'follow_reply'): ?>class="active"<?php else: ?> class="normal"<?php endif; ?>><span class="ico101">权限管理</span></a>
                        </dd>
                        </div>
                </dl>
                 <dl>
...
<div id="right">
   <form role="form" action="<?php echo U('xieyi_save');?>" name="adminadd"  method="post" enctype="multipart/form-data">
                               ...
                               <input type="hidden" name="id" value="<?php echo ($xieyi["id"]); ?>"/>
                                    <div class="form-group">
                                        <label><i style="color:red;"></i> 标题：</label>
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                         <input name="title" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('标题不能为空')" oninput="setCustomValidity('')" value="<?php echo ($xieyi["title"]); ?>"  />
                                        </div>
                                    </div>
                                        ...
                                        <div class="input-group" style="margin-top:10px;">
                                              ...
                                              <textarea rows="30" cols="80" placeholder="" name="content" id="content"><?php echo ($xieyi["content"]); ?></textarea>
                                              </div>
                                              </div>
                                        </div>
                                </div>
