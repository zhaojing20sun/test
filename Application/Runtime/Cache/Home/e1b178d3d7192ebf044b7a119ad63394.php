...
<div id="right">
   <form role="form" action="<?php echo U('word_add_save');?>" name="adminadd"  method="post" enctype="multipart/form-data">
                               ...
                               <input type="hidden" name="id" value="<?php echo ($weixin["id"]); ?>">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="margin-top:10px;margin-left:15px;">
                                         <input name="word" id="realname" type="text" class="form-control input-xlarge" required oninvalid="setCustomValidity('标题不能为空')" oninput="setCustomValidity('')"  value="<?php echo ($weixin["word"]); ?>"/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-actions" style="padding-left:5%;margin-top:20px">
