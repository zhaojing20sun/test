...
<table class="table table-bordered table-hover" style="text-align:center;    margin-top: 10px;">
                            <thead>
                             <tr><th>动态ID</th><th>文字</th><th style="width:150px;">配图</th><th>发布时间</th><th>浏览量</th><th>评论人数</th><th>操作</th></tr>
                            </thead>
                            <tbody>
                         ...
                         <td style="vertical-align:middle;max-width:150px;">
                           ...
                           <td style="vertical-align:middle;">
                             <?php $yaowen=M('weixin_release_pic')->where(array('aid'=>$v['id']))->select(); if($yaowen){ ?>  
