...
$(function(){
	...
	zsc_html = "<div class=\"list\" style=\"position:relative\">"+
			   ...
			   "<img id=\"zsc_imgs0\" src=\""+path+"/home/images/bigimg.jpg\" width=\"295\" height=\"126\"/>"+
			   "<span id=\"zsc_titles0\">标题</span>"+
			   "<b class=\"modify\"><img id=\"zsc_simg0\""+
			   " src=\""+path+"/home/images/op-modify.png\" onclick=\"zsc_editimg(0)\"/></b>"+
			   ...
			   "<img src=\""+path+"/home/images/keywords_28.jpg\" class=\"add1\" "+
			   "style=\"cursor:pointer;\" onclick=\"zsc_addimg(1)\" />"+
			   "</div>"+
			   "</div>"+
			   "<div class=\"tuwen_right\">"+
			   "<img src=\""+path+"/home/images/keywords_15.jpg\">"+
			   "<p>"+
			   "<br />"+
			   ...
			   "</p>"+
			   "<img src=\""+path+"/home/images/keywords_19.jpg\">"+ 
			   "</div>"+
			   "<div style=\" padding-top:45px; clear:both;\">"+
...
function zsc_addimg(num){
	if($('.simgcon').length<9){
		...
		var zsc_html = "<a href=\"javascript:;\" class=\"simgcon\" id=\"zsc_imgs"+num+"\">"+
					   "<span>标题</span>"+
					   "<img src=\""+path+"/home/images/smallimg.jpg\" id=\"zsc_simg"+num+"\" />"+
					   "<b class=\"smodify\"><img src=\""+path+"/home/images/op-modify.png\" onclick=\"zsc_editimg("+num+")\" />"+
					   "<img src=\""+path+"/home/images/op-del.png\" onclick=\"zsc_delimg("+num+")\" /></b>"+
...
function zsc_editimg(num){
	...
	if(0==zsc_count){
		$('#zsc_titles').val($('#zsc_titles0').html());
		$('#zsc_urls').val($('#zsc_urls0').val());
		if(path+'/home/images/bigimg.jpg'==$('#zsc_imgs0').attr('src')){
			$('#zsc_imgurls').val();
		}else{
			$('#zsc_imgurls').val($('#zsc_imgs0').attr('src'));
		}
		...
		if(path+'/home/images/smallimg.jpg'!=ssurl){
